...
class Player(pygame.sprite.Sprite):
    ...
    def input(self):
        ...
        if self.timers['tool use'].active or self.sleep: return
            ...
            if hasattr(sprite, 'hitbox'):
                if sprite.hitbox.colliderect(self.hitbox):
                    if direction == 'horizontal':
                        ...
                        elif self.direction.x < 0: self.hitbox.left = sprite.hitbox.right
                        self.rect.centerx = self.hitbox.centerx
                        self.pos.x = self.hitbox.centerx
                    elif direction == 'vertical':
                        if self.direction.y > 0: self.hitbox.bottom = sprite.hitbox.top
                        elif self.direction.y < 0: self.hitbox.top = sprite.hitbox.bottom
    ...
    def move(self, dt):
        ...
        self.hitbox.centery = self.rect.centery = round(self.pos.y)
